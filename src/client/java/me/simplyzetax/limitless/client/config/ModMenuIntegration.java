...
public class ModMenuIntegration implements ModMenuApi {
    ...
    private static Screen createConfigScreen(Screen parent) {
        ...
        ConfigCategory mainCategory = builder.getOrCreateCategory(Text.translatable("config.limitless.category.features"));
        
        mainCategory.addEntry(entryBuilder
                .startBooleanToggle(Text.translatable("config.limitless.feature.item_stealing"), ClientConfig.EnableItemStealingFeature)
        ...
        mainCategory.addEntry(entryBuilder
                .startBooleanToggle(Text.translatable("config.limitless.feature.shulker_box"), ClientConfig.EnableShulkerBoxFeature)
                .setDefaultValue(true)
        ...
        mainCategory.addEntry(entryBuilder
                .startBooleanToggle(Text.translatable("config.limitless.feature.glowing"), ClientConfig.EnableGlowingFeature)
                .setDefaultValue(true)
        ...
        mainCategory.addEntry(entryBuilder
                .startBooleanToggle(Text.translatable("config.limitless.feature.bow_trajectory"), ClientConfig.EnableBowTrajectoryFeature)
                .setDefaultValue(true)
        ...
        mainCategory.addEntry(entryBuilder
                .startBooleanToggle(Text.translatable("config.limitless.feature.arrow_dodge"), ClientConfig.EnableArrowDodgeFeature)
                .setDefaultValue(true)
        ...
        mainCategory.addEntry(entryBuilder
                .startBooleanToggle(Text.translatable("config.limitless.feature.damage_numbers"), ClientConfig.EnableDamageNumbersFeature)
                .setDefaultValue(true)
        ...
        ConfigCategory itemStealingCategory = builder.getOrCreateCategory(Text.translatable("config.limitless.category.item_stealing"));
        
        itemStealingCategory.addEntry(entryBuilder
                .startBooleanToggle(Text.translatable("config.limitless.item_stealing.only_player_items"), ClientConfig.OnlyStealPlayerItems)
                .setDefaultValue(false)
                .setTooltip(Text.translatable("config.limitless.item_stealing.only_player_items.tooltip"))
                .setSaveConsumer(newValue -> ClientConfig.OnlyStealPlayerItems = newValue)
                .build());
        
        itemStealingCategory.addEntry(entryBuilder
                .startBooleanToggle(Text.translatable("config.limitless.item_stealing.enable_stealing"), ClientConfig.EnableStealing)
                .setDefaultValue(true)
        ...
        ConfigCategory combatCategory = builder.getOrCreateCategory(Text.translatable("config.limitless.category.combat"));
        
        combatCategory.addEntry(entryBuilder
                .startBooleanToggle(Text.translatable("config.limitless.combat.players_glow"), ClientConfig.PlayersShouldGlow)
                .setDefaultValue(false)
        ...
        combatCategory.addEntry(entryBuilder
                .startBooleanToggle(Text.translatable("config.limitless.combat.show_bow_trajectory"), ClientConfig.ShowBowTrajectory)
                .setDefaultValue(false)
        ...
        combatCategory.addEntry(entryBuilder
                .startBooleanToggle(Text.translatable("config.limitless.combat.enable_arrow_dodging"), ClientConfig.EnableArrowDodging)
                .setDefaultValue(false)
        ...
        combatCategory.addEntry(entryBuilder
                .startBooleanToggle(Text.translatable("config.limitless.combat.show_damage_numbers"), ClientConfig.ShowDamageNumbers)
                .setDefaultValue(true)
        ...
        combatCategory.addEntry(entryBuilder
                ...
                .setEnumNameProvider(fontOption -> Text.literal(((DamageFontManager.FontOption) fontOption).getDisplayName()))
                .setSaveConsumer(fontOption -> ClientConfig.DamageNumberFont = ((DamageFontManager.FontOption) fontOption).getKey())
                .build());
        
        // Zoom Settings Category
        ConfigCategory zoomCategory = builder.getOrCreateCategory(Text.translatable("config.limitless.category.zoom"));
        
        zoomCategory.addEntry(entryBuilder
                .startBooleanToggle(Text.translatable("config.limitless.zoom.enable_zoom"), ClientConfig.EnableZoom)
                .setDefaultValue(true)
        ...
        zoomCategory.addEntry(entryBuilder
                .startFloatField(Text.translatable("config.limitless.zoom.zoom_level"), ClientConfig.ZoomLevel)
        ...
        zoomCategory.addEntry(entryBuilder
                .startFloatField(Text.translatable("config.limitless.zoom.min_zoom_level"), ClientConfig.MinZoomLevel)
        ...
        zoomCategory.addEntry(entryBuilder
                .startFloatField(Text.translatable("config.limitless.zoom.max_zoom_level"), ClientConfig.MaxZoomLevel)
        ...
        zoomCategory.addEntry(entryBuilder
                .startFloatField(Text.translatable("config.limitless.zoom.scroll_sensitivity"), ClientConfig.ZoomScrollSensitivity)
